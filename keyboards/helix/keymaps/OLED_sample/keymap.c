...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = KEYMAP( \
      ...
      LT(_INDEXF,KC_TAB),  KC_Q, KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,   LT(_INDEXF,KC_BSLS), \
      KC_LSFT,  KC_A,   KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,   KC_SCLN, KC_RSFT, \
      KC_LCTL, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT, KC_SLSH, KC_RCTL, \
      ADJUST,  LOWER, KC_CAPS, KC_LALT, KC_LGUI, KC_ENT,  KC_SPC, KC_RGUI, KC_RALT,  KC_MENU, LOWER,   RAISE   \
      ),
  ...
  [_INDEXF] = KEYMAP( \
      ...
      _______, _______, _______, _______, LSFT(KC_GRV),  KC_GRV,    KC_QUOT, LSFT(KC_QUOT), _______, _______, _______, _______, \
